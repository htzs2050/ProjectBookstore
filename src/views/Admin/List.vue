  ...
  <div>
    ...
    width:85%;">
      <div style="margin-bottom: 25px">
        <el-input style="width: 240px;" placeholder="搜索用户名" v-model="params.username"></el-input>
        ...
        <el-input style="width: 240px;" placeholder="搜索邮箱" v-model="params.email"></el-input>
        <el-button style="margin-left: 5px;" type="primary" @click="load"><i class="el-icon-search"></i>搜索</el-button>
        <el-button style="margin-left: 5px;" type="warning" @click="reset"><i class="el-icon-refresh"></i> 重置</el-button>
      </div>
    </div>
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="accountId" label="ID" width="180">
      </el-table-column>
      ...
      <el-table-column label="操作">
        <template v-slot="scope">
          <!--          scope.row就是当前行数据-->
          <el-button type="warning" icon="el-icon-edit"  @click="$router.push('/ManageAdmin?accountId=' + scope.row.accountId)">修改
          </el-button>
          <el-popconfirm
...
export default {
  ...
  methods:{
    ...
    del(accountId){
      request.delete("/admin/delete/" + accountId).then(res => {
        if(res.code === '200') {
